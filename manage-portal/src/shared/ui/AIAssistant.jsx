...
function ResultList({ module, results }) {
  if (!results || results.length === 0) return (
    <div style={{ textAlign: "center", padding: "12px 0", color: "#94a3b8", fontSize: 12 }}>No results found.</div>
  );
  return (
...
export default function AIAssistant() {
  ...
  const [messages, setMessages] = useState([
    { role: "assistant", text: "Hi! I'm your AI assistant 👋 Ask me anything about employees, leaves, tasks, or payroll." }
  ]);
  ...
  const send = async (queryText) => {
    ...
    try {
      ...
      if (!data.module) {
        setMessages(prev => [...prev, { role: "assistant", text: data.summary || "I couldn't understand that. Try something like 'Show inactive employees' or 'Pending leaves from HR'." }]);
      } else {
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          color: "#fff", boxShadow: "0 4px 20px rgba(37,99,235,0.45)",
        ...
        <div style={{
          ...
          <div style={{ background: "linear-gradient(135deg, #2563eb, #7c3aed)", padding: "14px 16px", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: "rgba(255,255,255,0.75)" }}>Employees · Leaves · Tasks · Payroll</div>
            </div>
          </div>
          ...
          <div style={{ padding: "10px 12px", borderTop: "1px solid #f1f5f9", display: "flex", gap: 8, alignItems: "center" }}>
            <input
              ...
              style={{
                ...
                outline: "none", color: "#0f172a", background: loading ? "#f8fafc" : "#fff",
              }}
